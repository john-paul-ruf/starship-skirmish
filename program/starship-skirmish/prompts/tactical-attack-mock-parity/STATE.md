...
| 02 | Build Legible Tactical Field Primitives | M13, M19 | `./src/render/TacticalView.ts`; `./src/render/labels.ts`; `./src/render/range.ts`; `./tests/unit/render/labels.test.ts`; `./tests/unit/render/range.test.ts` | pending | — | — | Visible semantic labels and line-only range envelopes. |
